...
describe("Register Page testing",()=>{
    ...
    it("Firstname placeholder to be there",()=>{
        render(
        <BrowserRouter>
        <Registerpage/>
        </BrowserRouter>)
       
         expect(screen.getByPlaceholderText("Firstname")).toBeTruthy(); 
    });

    
    it("Lastname placeholder to be there",()=>{
        render(
        <BrowserRouter>
        <Registerpage/>
        </BrowserRouter>)
       
         expect(screen.getByPlaceholderText("Lastname")).toBeTruthy(); 
    });
