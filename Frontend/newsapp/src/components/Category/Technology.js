...
function Technology() {
 ...
 const [technology,setTechnology]=useState([]);
  ...
  const DataTechnology =async()=>{
    let { data } = await axios.get(`${config.newsapi}/category/technology`);
    setTechnology(data);
  ...
  return (
    <div>
      ...
      <div className="container">
        <h1 className="head-text text-center fw-bold shadow bg-secondary text-light">Technology News</h1>
