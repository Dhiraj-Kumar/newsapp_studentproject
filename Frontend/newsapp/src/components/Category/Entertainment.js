...
function Entertainment() {
 ...
 const [entertainment,setEntertainment]=useState([]);
  ...
  const DataEntertainment =async()=>{
    let { data } = await axios.get(`${config.newsapi}/category/entertainment`);
  ...
  return (
    <div>
      ...
      <div className="container">
        <h1 className="head-text text-center fw-bold shadow bg-secondary text-light">Entertainment News</h1>
