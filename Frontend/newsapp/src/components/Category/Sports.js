...
function Sports() {
 ...
 const [sports,setSports]=useState([]);
  ...
  const DataSports =async()=>{
    let { data } = await axios.get(`${config.newsapi}/category/Sports`);
    setSports(data);
  ...
  return (
    <div>
      ...
      <div className="container">
        <h1 className="head-text text-center fw-bold shadow bg-primary text-light">Sports News</h1>
